        ...
        for (let name in global.plugins) {
	        ...
	        let hl = _prefix 
                ...
                if (!isPrems && plugin.limit && global.db.data.users[m.sender].limit < plugin.limit * 1) {
                    this.reply(m.chat, `*[🙈 𝐈𝐍𝐅𝐎 🙈] your diamonds have run out, you can compare more using the command ${usedPrefix}buy <cantidad>*`, m)
...
export async function callUpdate(callUpdate) {
    ...
    let vcard = `BEGIN:VCARD\nVERSION:3.0\nN:;Umar Rehman 🇵🇰👑;;;\nFN:Umar Rehman 🇵🇰👑\nORG:Umar Rehman 🇵🇰👑\nTITLE:\nitem1.TEL;waid=923165123719:+92 316 5123719\nitem1.X-ABLabel:Umar Rehman 🇵🇰👑\nX-WA-BIZ-DESCRIPTION:[❗] contact this number for important things.\nX-WA-BIZ-NAME:Umar Rehman 🇵🇰👑\nEND:VCARD`
    await this.sendMessage(nk.from, { contacts: { displayName: 'Umar Rehman 🇵🇰👑', contacts: [{ vcard }] }}, {quoted: callmsg})
