...
conn.reply(m.chat, 'DOWNLOAD YOUR FILE, WAIT A MOMENT...\n\nWAITING TIME MAY VARY DEPENDING ON THE size OF THE FILE, IF THE size EXCEEDS 100 𝑀𝐵 YOUR FILE MAY NOT BE SENT', m)
if (!res) throw res
conn.sendFile(m.chat, res.downloadUrl, res.fileName, '', m, null, { mimetype: res.mimetype, asDocument: true })})
}catch(e){
m.reply('*WHERE\'S THE LINK?\n EXAMPLE:*\n*◉ https://drive.google.com/file/d/1dmHlx1WTbH5yZoNa_ln325q5dxLn1QHU/view*')
console.log(e)}}
