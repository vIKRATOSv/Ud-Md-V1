...
if (!args[0]) throw `*WHERE\'S THE LINK?\n EXAMPLE: ${usedPrefix + command}* https://fb.watch/fOTpgn6UFQ/` 
if (!args[0].match(/www.facebook.com|fb.watch/g)) throw `*WHERE\'S THE LINK?\n EXAMPLE: ${usedPrefix + command}* https://fb.watch/fOTpgn6UFQ/`
try {
await m.reply(`*DOWNLOADING VIDEO, WAIT...,\nIT WILL TAKE 2 - 10 MIN DEPENDING ON THE SIZE OF YOUR VIDEO...*`)
switch (command) {   
...
await await m.reply(`*ERROR, PLEASE TRY AGAIN, IF THE ERROR CONTINUES, TRY ANOTHER OPTION (${usedPrefix}fb, ${usedPrefix}fb2, ${usedPrefix}fb3, ${usedPrefix}fb4, ${usedPrefix}fb5)*`)
}}
